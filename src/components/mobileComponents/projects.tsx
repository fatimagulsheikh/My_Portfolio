...
const MobileProjects = () => {
  ...
  return (
    <div className="w-full p-5 border-b border-indigo-200 pb-6 mb-6 bg-gray-50">
      <h2 className="text-4xl font-extrabold text-indigo-800 uppercase tracking-widest">Projects</h2>
